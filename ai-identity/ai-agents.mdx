...
The red-team skills probe your agent; a **judge model** decides whether each response is a real finding. The judge is one of your configured [AI providers](mailto:sales@breachlens.app?subject=BreachLens%20AI%20providers) — **Anthropic, OpenAI, or a local Ollama**. If no AI provider is active for your org, the scan can't judge results and will fail, so configure one first.
