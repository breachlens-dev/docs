...
<Note>
  The **API playground** in the sidebar covers the **scan endpoints** — trigger, status, and SARIF export — generated from the OpenAPI spec. This page stays the canonical reference for everything else: the findings API, the SSE progress stream, rate limits, and the full error table, none of which the playground includes.
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="BreachLens as an MCP server" icon="plug" href="/mcp">
    Roadmap — expose findings and scans to your AI agents natively.
  </Card>
