...
Before you run it, you can ask BreachLens to **review the fix**. The Fix panel's **AI review** gives a second opinion on that exact command — a verdict (safe / caution / risky), what it changes (its blast radius), any new exposure it might introduce, and a short pre-flight checklist of things to confirm first. It's advisory only: it never applies or blocks the fix, and you always read the command yourself.
