...
<Note>
  ECR is the fully-supported reference path. If a private ACR / GAR / Docker Hub connection needs a hand for your setup, [reach out](mailto:hi@breachlens.app?subject=BreachLens%20private%20registry) — we'll get it wired.
</Note>
