...
<CardGroup cols={2}>
  ...
  <Card title="Compliance reporting" icon="clipboard-check" href="mailto:hi@breachlens.app?subject=BreachLens%20compliance%20reporting">
    Roll posture and code findings into framework-mapped, exportable evidence packs.
  </Card>
</CardGroup>
