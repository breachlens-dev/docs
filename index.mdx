...
<Steps>
  <Step title="Install — about 10 minutes">
    Bring up the stack with `docker compose`, set your license, and create your owner account.
    [Quickstart →](/quickstart)
  </Step>
  <Step title="Connect a repository">
    Install the GitHub App (or add a repo by URL) and run your first scan — findings in under a minute.
    [Scan a repository →](/scanning/repositories)
  </Step>
  <Step title="Prove and fix what matters">
    Filter to Critical/High with an attack path, open a finding, and generate an auto-fix pull request.
    [Fit it into CI/CD →](/pipeline/cicd)
  </Step>
</Steps>
...
- A unified platform that consolidates SCA, container, IaC, DAST, cloud-posture and pentest into one pipeline (it embeds engines like Trivy and OWASP ZAP)
