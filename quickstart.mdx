...
<Tip>
  Want to see it in action before installing? These docs ship an interactive [API playground](/api) wired to a public sandbox — hit **Send** on any endpoint and get real, sanitized findings back, no signup. For a walkthrough of the running app, [ask us for a demo](mailto:sales@breachlens.app?subject=BreachLens%20demo).
</Tip>
