...
<Steps>
  ...
  <Step title="Set your license">
    ...
    <Note>
      The license is verified at api startup against an embedded public key — no call home. Without a valid license the api still boots, but premium features stay disabled until you apply one. See [Licensing](/deployment/licensing) for exactly what's gated and how to apply a license.
    </Note>
  </Step>
